package indi.xezzon.school.eams.service.impl;
...
import indi.xezzon.school.eams.repository.CourseMapper;
import indi.xezzon.school.eams.repository.CourseStudentRelMapper;
import indi.xezzon.school.eams.service.CourseService;
import indi.xezzon.school.eams.service.FeignAuthService;
...
class PreselectCourseHandler implements ElectCourseHandler {
    ...
    PreselectCourseHandler(RedisTemplate<String, Serializable> redisTemplate) {
        this.redisTemplate = redisTemplate;
        this.coursePrefix = "school-eams:preselect-course:course:";
        this.studentPrefix = "school-eams:preselect-course:student:";
    }
